...
public class AddBatchView extends JFrame {
	...
	public AddBatchView() {
		...
		frame.getContentPane().add(lblBatchname);
		...
		frame.getContentPane().add(total_set);
		...
		frame.getContentPane().add(des_area);
		...
		frame.getContentPane().add(btnAddBatch);
		...
		frame.getContentPane().add(lblBatchtime);
