...
public class EnquireDTO {
	...
	public Timestamp getCurrentTimeStamp() {
		...
		return CurrentTimeStamp = new java.sql.Timestamp(today.getTime());
	}
	...
	public String toString() {
		return "EnquireDTO [firstName=" + firstName + ", secondName=" + secondName + ", mobileContact=" + mobileContact
				...
				+ ", address2=" + address2 + ", email=" + email + ", coursename=" + coursename + ", enquireContactDate="
				+ enquireContactDate + ", CurrentTimeStamp=" + CurrentTimeStamp + "]";
	}
}
