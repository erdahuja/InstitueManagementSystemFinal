...
public class EnquireExcelDTO {
	...
	private Date enquireContactDate;
	...
	public Date getEnquireContactDate() {
		return enquireContactDate;
	}
	public void setEnquireContactDate(Date enquireContactDate) {
		this.enquireContactDate = enquireContactDate;
	}
	...
	public String toString() {
		return "EnquireExcelDTO [firstName=" + firstName + ", secondName=" + secondName + ", mobileContact="
				+ mobileContact + ", otherContact=" + otherContact + ", slot1=" + slot1 + ", slot2=" + slot2
				+ ", university=" + university + ", qualification=" + qualification + ", reference=" + reference
				+ ", fatherFirstName=" + fatherFirstName + ", fatherSecondName=" + fatherSecondName
				+ ", fatherMobileContact=" + fatherMobileContact + ", fatherOtherContact=" + fatherOtherContact
				+ ", address1=" + address1 + ", address2=" + address2 + ", email=" + email + ", Coursename="
				+ Coursename + ", enquireContactDate=" + enquireContactDate + ", EnquireDate=" + EnquireDate
				+ ", EnquireID=" + EnquireID + "]";
	}
}