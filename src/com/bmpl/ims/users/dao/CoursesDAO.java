	...
	public String updateCourse(String item) throws SQLException {
		...
		try {
			...
			while (rs.next()) {
				...
				addCourseDTO.setCourse_name(rs.getString(2));
				addCourseDTO.setFees(Integer.parseInt(rs.getString(3)));
				addCourseDTO.setCourse_description(rs.getString(4));
				addCourseDTO.setDuration(Integer.parseInt(rs.getString(5)));
				addCourseDTO.setTrainer_name(rs.getString(6));
